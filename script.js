...
// var amounts = [10,20,30,40];
// console.log(amounts);

// for(let i=0; i<amounts.length; i++)
// {
//     console.log(amounts[i]*0.014);
// }
// console.log(amounts);

// // map accepts the parameter using call back functions
// const finalarray = amounts.map(function(el){
//     return el*0.014;
// });
// console.log(finalarray);

// method results when object.function i.e. amounts.map(obj.function)
//filters
//filters applies a condition to every element and verifies the condition

// const arr = [2,5,15,48,32,33];
// const finarr = arr.filter(function(el)   // Here if map is used it check and results undefined if not satisfied but in filter it checks appropriate one 
// {
//      if(el%2==0)
//      return el;
// });
